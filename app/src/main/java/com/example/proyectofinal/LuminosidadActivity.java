...
public class LuminosidadActivity extends AppCompatActivity {
    ...
    private LineChart graficaLuminosidad;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        graficaLuminosidad = findViewById(R.id.graficaLuminosidad);
        ...
        try {
            ...
            graficaLuminosidad.setBorderWidth(0.9f);
            //Se le pasan los datos al objeto de tipo gráfica
            graficaLuminosidad.setData(data);
            ...
            XAxis xAxis = graficaLuminosidad.getXAxis();
